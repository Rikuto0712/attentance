...
public class AttendanceController {
	...
	public String punch(@AuthenticationPrincipal UserDetails userDetails,
	...
	public String submitFixRequest(@AuthenticationPrincipal UserDetails userDetails,
		...
		fixRequestService.createFixRequest(currentUser, attendanceId,
				newCheckInTime, newCheckOutTime, newBreakStartTime, newBreakEndTime, reason);
